...
public interface Puissance4 {
     ...
     * 
     * @param grille
     *            une grille de puissance 4 (6 lignes x 7 colonnes). Une case vide est représentée par le caractère '-', Une case occupée
     *            par un jeton rouge, par le caractère 'R' Une case occupée par un jeton jaune, par le caractère 'J'.
     * @param tour
    ...
    /**
     * @return l'état dans lequel est le jeu : EN_COURS, ROUGE_GAGNE, JAUNE_GAGNE, MATCH_NUL
     */
     ...
     * @param colonne
     *            de 0 à 6
     * @return la couleur - R(ouge) ou J(aune) - du jeton occupant la case aux coordonnées saisies en paramètre (si vide, '-')
     * @throws IllegalArgumentException
     ...
     * 
     * @param colonne
     *            numéro de colonne où le joueur courant fait glisser son jeton (compris entre 0 et 6)
