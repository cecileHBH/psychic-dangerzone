...
import fr.ippon.contest.puissance4.impl.Puissance4Impl;
...
public class Puissance4Test {
    ...
    public void testChargerLigneGagnante() {
        char[][] grille = { { '-', '-', '-', '-', '-', 'J', 'R' }, { '-', '-', 'J', 'R', '-', 'R', 'J' },
                { '-', 'R', 'R', 'R', '-', 'R', 'J' }, { '-', 'J', 'J', 'J', 'J', 'J', 'J' }, { '-', 'R', 'J', 'R', 'R', 'J', 'R' },
                { 'J', 'R', 'J', 'J', 'R', 'J', 'R' } };
        jeu.chargerJeu(grille, 'R');
    ...
    public void testChargerDiagonaleGagnante() {
        ...
        char[][] grille2 = { { '-', '-', '-', '-', '-', '-', '-' }, { 'R', 'R', 'R', 'J', '-', '-', 'R' },
                { 'J', 'J', 'J', 'R', 'J', 'R', 'J' }, { 'R', 'R', 'J', 'J', 'R', 'J', 'J' }, { 'R', 'J', 'R', 'R', 'R', 'J', 'R' },
                { 'R', 'J', 'J', 'R', 'R', 'J', 'J' } };
    ...
    public void testJouerNul() {
        char[][] grille = { { 'R', '-', 'J', 'R', 'J', 'R', 'J' }, { 'J', 'R', 'R', 'J', 'R', 'R', 'R' },
                { 'R', 'J', 'J', 'J', 'R', 'J', 'J' }, { 'J', 'R', 'R', 'J', 'R', 'R', 'R' }, { 'J', 'J', 'R', 'R', 'J', 'J', 'J' },
                { 'R', 'J', 'J', 'J', 'R', 'R', 'R' } };
        jeu.chargerJeu(grille, 'J');
        assertEquals(EtatJeu.EN_COURS, jeu.getEtatJeu());
        jeu.jouer(1);
    ...
    public void testChargerNul() {
        char[][] grille = { { 'R', 'J', 'J', 'R', 'J', 'R', 'J' }, { 'J', 'R', 'R', 'J', 'R', 'R', 'R' },
                { 'R', 'J', 'J', 'J', 'R', 'J', 'J' }, { 'J', 'R', 'R', 'J', 'R', 'R', 'R' }, { 'J', 'J', 'R', 'R', 'J', 'J', 'J' },
                { 'R', 'J', 'J', 'J', 'R', 'R', 'R' } };
        jeu.chargerJeu(grille, 'J');
        assertEquals(EtatJeu.MATCH_NUL, jeu.getEtatJeu());
